...
```text
DISCORD_TOKEN, DISCORD_LOG_CHANNEL_ID, DISCORD_COMMAND_CHANNEL_ID, DISCORD_CHAT_CHANNEL_ID, OLLAMA_BASE_URL, OLLAMA_MODEL, EXTERNAL_SERVICE_URL, NODE_ID, FEDERATION_SECRET, FEDERATION_PEERS, ADVANCED_EXPERIENCE_MODE, LOG_LEVEL, JSON_LOGS, PORT, ENFORCE_GUARDRAIL, API_SERVER_SECRET, AIOME_DB_PATH, KEY_PROXY_URL, KEY_PROXY_PORT
```

---
*Last Auto-Generated: 2026-03-13 04:36:02 UTC*
